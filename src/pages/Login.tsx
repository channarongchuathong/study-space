...
function Login() {
    return (
        <div className="bg-background text-text min-h-screen flex w-full h-full justify-center items-center">
            <div className="flex flex-col gap-4 w-150 p-10 rounded-xl border border-border bg-surface">
                ...
                <div className="flex flex-col gap-2">
                    ...
                    <div className="flex justify-between">
                        <div className="flex gap-2 items-center">
                            <input type="checkbox" className="checkbox w-5 h-5 border rounded-md"/>
                            จดจำฉันไว้
                        </div>
                        <p className="text-primary">ลืมรหัสผ่าน?</p>
                    </div>
                </div>
                <button className="text-text rounded-lg bg-primary border-border px-3 py-2 hover:cursor-pointer hover:bg-primary/80 transition-all">เข้าสู่ระบบ</button>
                <div className="flex items-center gap-3">
                    <div className="flex-1 bg-border h-0.5"></div>
                    <div>หรือเข้าสู่ระบบด้วย</div>
                    <div className="flex-1 bg-border h-0.5"></div>
                </div>
                <div className="flex flex-col gap-2">
                    ...
                    <button className="btn bg-[#1A77F2] text-white border-[#005fd8] rounded-lg">
