...
## การใช้งาน API
โปรเจกต์นี้ดึงข้อมูลคอร์สเรียนและหมวดหมู่จาก Mock REST API ที่รันแยกจากตัวเว็บไซต์ โดยใช้คำสั่ง fetch สำหรับเรียกข้อมูลผ่าน HTTP
API ที่ใช้งาน ได้แก่
- GET /courses — ดึงรายการคอร์สทั้งหมด
- GET /categories — ดึงรายการหมวดหมู่ของคอร์ส
ข้อมูลที่ได้รับจาก API จะถูกนำมาใช้สำหรับ
- แสดงรายการคอร์สทั้งหมด
- ค้นหาคอร์สจากชื่อหลักสูตร
- กรองคอร์สตามหมวดหมู่
- แสดงรายละเอียดคอร์สและรายการบทเรียน
โปรเจกต์นี้ใช้ Mock API สำหรับจำลองการทำงานของ Backend เพื่อฝึกการพัฒนา Frontend และการจัดการข้อมูลจาก REST API
