            ...
            <div className='container mx-auto'>
                <footer className="footer sm:footer-horizontal bg-base-200 text-text p-10">
                    ...
                    <nav>
                        ...
                        <a className="link link-hover">การเขียนโปรแกรม</a>
                        <a className="link link-hover">การออกแบบ</a>
                        <a className="link link-hover">ธุรกิจ</a>
                        <a className="link link-hover">พัฒนาตนเอง</a>
                    </nav>
                    <nav>
