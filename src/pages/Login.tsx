...
function Login() {
    return (
        <div className="bg-background text-text min-h-screen flex w-full h-full justify-center items-center p-6 lg:p-0">
            <div className="flex flex-col w-150 rounded-xl border border-border bg-surface">
                ...
                <div className="p-6 lg:p-10 w-full flex flex-col gap-4">
                    ...
                    <div className="flex flex-col gap-2">
                        ...
                        <button className="btn bg-black font-normal text-white border-black rounded-lg">
                            ...
                            <div className="hidden lg:flex">ดำเนินการต่อด้วย</div> Apple
                        </button>
                    </div>
                    <div className="flex gap-5 justify-center text-sm lg:text-base">
                        <p>ยังไม่มีบัญชี?</p>
